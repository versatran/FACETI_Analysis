...
outputdir = strcat('C:', filesep, 'Users', filesep, 'bflor', filesep, 'Documents', filesep, 'Research', filesep);
...
setappdata(0, 'outputFileName', outputFileName);
...
setappdata(0, 'num_stacks_m', num_stacks);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
